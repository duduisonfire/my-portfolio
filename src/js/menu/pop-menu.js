...
document.addEventListener('click', e => {
    if (e.target.id === 'sm-menu') {
        if (controller === 0) {
            ...
            div.innerHTML = `<ul><li class="my-2 px-4"><a href="./index.html" class="hover:text-purple-800 text-sm">Home</a></li>
                            <li class="my-2 px-4"><a href="#" class="hover:text-purple-800 text-sm">About</a></li>
                            <li class="my-2 px-4"><a href="#" class="hover:text-purple-800 text-sm">Projects</a></li></ul>`;
